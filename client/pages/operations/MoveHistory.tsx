...
const MoveHistory = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await apiMock.moves.getMoveHistory();
        setData(result);
      } catch (error) {
  ...
  // Sort data: grouped references should ideally stay together for list view
  // For prototype, we just use the order from API
